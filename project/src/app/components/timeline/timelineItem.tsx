...
export default function TimelineItem({ 
  ...
  const flexDirection = isEven ? "flex-row" : "flex-row-reverse"
    ...
    const dateClass = isMdUp ? (isEven ? "absolute flex justify-end md:w-1/2 text-right pr-8" : "flex justify-start md:w-1/2 text-left ml-16") : "flex justify-start md:w-full text-left ml-16 origin-top-right"
